...
void mvDebugWindow::drawWidgets()
{
    ...
    ImGuiIO& io = ImGui::GetIO();
        ...
        ImGui::BeginChild("CommandsChild##debug", ImVec2(400.0f, 400.0f), ImGuiChildFlags_Borders);
        ...
        ImGui::EndChild();
        ImGui::SameLine();
        ImGui::BeginChild("CommandsDoc##debug", ImVec2(-1.0f, 400.0f), ImGuiChildFlags_Borders);
