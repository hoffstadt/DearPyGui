...
### Introduction to Dear PyGui ([YouTube](https://www.youtube.com/watch?v=kkRXLrG5oMA))
...
### Basics of callbacks ([YouTube](https://youtu.be/5ci4oIzGXdI))
...
### ID system and debug tool ([YouTube](https://youtu.be/zcGWJjGSn-w))
...
### Parent stack system ([YouTube](https://youtu.be/CVoArPhOLx4))
...
* The simple module adds the context managers (e.g. 'with window' ). The with_ statements of the context managers automate the application of the end() statement, making the code easier to read.

### Value Storage System ([YouTube](https://youtu.be/b7gm0f5vYcc))
...
### Widget basics ([YouTube](https://youtu.be/tqETQz2As9g))
...
* It is demonstrated how a progres bar widget can be controlled via a drag_int slider using set_value(...) and configure_item(...)
...
### Tab bar, tabs, and tab button basics ([YouTube](https://youtu.be/-NXf98oj70c))
...
### Simple Plot & Tooltip - ([YouTube](https://youtu.be/G1l-rtMUlsI))
* [Simple plot](https://github.com/hoffstadt/DearPyGui/wiki/Simple-Plots) is for plotting simple data. This is not to be confused with the more powerful and complex [Plots](https://github.com/hoffstadt/DearPyGui/wiki/Plots).
...
* add_text(“Hover me”, tip=”A simple tooltip”). This simple tooltip is only for text. The [tooltip widget](https://github.com/hoffstadt/DearPyGui/wiki/Tooltips) is more powerful.
...
### Popups ([YouTube]( https://www.youtube.com/watch?v=paClQ6SewX8))
* [Popups](https://github.com/hoffstadt/DearPyGui/wiki/Popups) require a parent. That may change in future versions of Dear PyGui.
...
### Experimental Windows Docking ([YouTube](https://www.youtube.com/watch?v=dVm2U6kZb7U))
...
### Smart tables ([YouTube](https://youtu.be/qL_zjinXTJk))
...
View all [video tutorials on Dear PyGui](https://www.youtube.com/playlist?list=PLcqt7R3y3elGh7zoj1-oyygzTh9j81hKV) by the core developers on YouTube.

## Dear PyGui video tutorials by the community 
### Creating a complete Python app with Dear PyGui ([YouTube](https://youtu.be/2RocXKPPx4o))
...
## Applications developed with Dear PyGui 
...
### About Dear PyGui
Dear PyGui is a [user-friendly, flexible, powerful and cross-platform GUI framework for Python](https://github.com/hoffstadt/DearPyGui). It supports the creation of apps on Windows, Linux and MacOS. As an extended wrapping of Dear ImGui, Dear PyGui is highly performant. While is primarily written in C/C++ and uses your GPU for renderering, the Python API for Dear PyGui is presented to the developer in a clean and accessible manner.