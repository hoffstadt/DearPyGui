...
def create_theme_imgui_dark() -> Union[str, int]:
    ...
    with dpg.theme() as theme_id:
        with dpg.theme_component(0):
            ...
            dpg.add_theme_color(dpg.mvThemeCol_InputTextCursor        , (1.00 * 255, 1.00 * 255, 1.00 * 255, 1.00 * 255))
            ...
            dpg.add_theme_color(dpg.mvThemeCol_TabSelected            , (0.20 * 255, 0.41 * 255, 0.68 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabSelectedOverline    , (0.26 * 255, 0.59 * 255, 0.98 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabDimmed              , (0.07 * 255, 0.10 * 255, 0.15 * 255, 0.97 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabDimmedSelected      , (0.14 * 255, 0.26 * 255, 0.42 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabDimmedSelectedOverline, (0.50 * 255, 0.50 * 255, 0.50 * 255, 0.00 * 255))
            ...
            dpg.add_theme_color(dpg.mvThemeCol_TextLink               , (0.26 * 255, 0.59 * 255, 0.98 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TextSelectedBg         , (0.26 * 255, 0.59 * 255, 0.98 * 255, 0.35 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TreeLines              , (0.43 * 255, 0.43 * 255, 0.50 * 255, 0.50 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_DragDropTarget         , (1.00 * 255, 1.00 * 255, 0.00 * 255, 0.90 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_DragDropTargetBg       , (0.00 * 255, 0.00 * 255, 0.00 * 255, 0.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_UnsavedMarker          , (1.00 * 255, 1.00 * 255, 1.00 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_NavCursor              , (0.26 * 255, 0.59 * 255, 0.98 * 255, 1.00 * 255))
            ...
            dpg.add_theme_color(dpg.mvPlotCol_AxisGrid                , (1.00 * 255, 1.00 * 255, 1.00 * 255, 0.25 * 255), category=dpg.mvThemeCat_Plots)
            ...
            dpg.add_theme_color(dpg.mvNodeCol_GridLinePrimary         , (240, 240, 240, 60), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapBackground       , (25, 25, 25, 150), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapBackgroundHovered, (25, 25, 25, 200), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapOutline          , (150, 150, 150, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapOutlineHovered   , (150, 150, 150, 200), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapNodeBackground   , (200, 200, 200, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapNodeBackgroundHovered, (200, 200, 200, 255), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapNodeBackgroundSelected, (200, 200, 200, 255), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapNodeOutline      , (200, 200, 200, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapLink             , (61, 133, 224, 200), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapLinkSelected     , (66, 150, 250, 255), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapCanvas           , (200, 200, 200, 25), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapCanvasOutline    , (200, 200, 200, 200), category=dpg.mvThemeCat_Nodes)

    return theme_id

def create_theme_imgui_classic() -> Union[str, int]:

    with dpg.theme() as theme_id:
        with dpg.theme_component(0):
            dpg.add_theme_color(dpg.mvThemeCol_Text                   , (0.90 * 255, 0.90 * 255, 0.90 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TextDisabled           , (0.60 * 255, 0.60 * 255, 0.60 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_WindowBg               , (0.00 * 255, 0.00 * 255, 0.00 * 255, 0.85 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ChildBg                , (0.00 * 255, 0.00 * 255, 0.00 * 255, 0.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_PopupBg                , (0.11 * 255, 0.11 * 255, 0.14 * 255, 0.92 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_Border                 , (0.50 * 255, 0.50 * 255, 0.50 * 255, 0.50 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_BorderShadow           , (0.00 * 255, 0.00 * 255, 0.00 * 255, 0.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_FrameBg                , (0.43 * 255, 0.43 * 255, 0.43 * 255, 0.39 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_FrameBgHovered         , (0.47 * 255, 0.47 * 255, 0.69 * 255, 0.40 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_FrameBgActive          , (0.42 * 255, 0.41 * 255, 0.64 * 255, 0.69 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TitleBg                , (0.27 * 255, 0.27 * 255, 0.54 * 255, 0.83 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TitleBgActive          , (0.32 * 255, 0.32 * 255, 0.63 * 255, 0.87 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TitleBgCollapsed       , (0.40 * 255, 0.40 * 255, 0.80 * 255, 0.20 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_MenuBarBg              , (0.40 * 255, 0.40 * 255, 0.55 * 255, 0.80 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ScrollbarBg            , (0.20 * 255, 0.25 * 255, 0.30 * 255, 0.60 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ScrollbarGrab          , (0.40 * 255, 0.40 * 255, 0.80 * 255, 0.30 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ScrollbarGrabHovered   , (0.40 * 255, 0.40 * 255, 0.80 * 255, 0.40 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ScrollbarGrabActive    , (0.41 * 255, 0.39 * 255, 0.80 * 255, 0.60 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_CheckMark              , (0.90 * 255, 0.90 * 255, 0.90 * 255, 0.50 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_SliderGrab             , (1.00 * 255, 1.00 * 255, 1.00 * 255, 0.30 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_SliderGrabActive       , (0.41 * 255, 0.39 * 255, 0.80 * 255, 0.60 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_Button                 , (0.35 * 255, 0.40 * 255, 0.61 * 255, 0.62 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ButtonHovered          , (0.40 * 255, 0.48 * 255, 0.71 * 255, 0.79 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ButtonActive           , (0.46 * 255, 0.54 * 255, 0.80 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_Header                 , (0.40 * 255, 0.40 * 255, 0.90 * 255, 0.45 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_HeaderHovered          , (0.45 * 255, 0.45 * 255, 0.90 * 255, 0.80 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_HeaderActive           , (0.53 * 255, 0.53 * 255, 0.87 * 255, 0.80 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_Separator              , (0.50 * 255, 0.50 * 255, 0.50 * 255, 0.60 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_SeparatorHovered       , (0.60 * 255, 0.60 * 255, 0.70 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_SeparatorActive        , (0.70 * 255, 0.70 * 255, 0.90 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ResizeGrip             , (1.00 * 255, 1.00 * 255, 1.00 * 255, 0.10 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ResizeGripHovered      , (0.78 * 255, 0.82 * 255, 1.00 * 255, 0.60 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ResizeGripActive       , (0.78 * 255, 0.82 * 255, 1.00 * 255, 0.90 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_InputTextCursor        , (0.90 * 255, 0.90 * 255, 0.90 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabHovered             , (0.45 * 255, 0.45 * 255, 0.90 * 255, 0.80 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_Tab                    , (0.34 * 255, 0.34 * 255, 0.68 * 255, 0.79 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabSelected            , (0.40 * 255, 0.40 * 255, 0.73 * 255, 0.84 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabSelectedOverline    , (0.53 * 255, 0.53 * 255, 0.87 * 255, 0.80 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabDimmed              , (0.28 * 255, 0.28 * 255, 0.57 * 255, 0.82 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabDimmedSelected      , (0.35 * 255, 0.35 * 255, 0.65 * 255, 0.84 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabDimmedSelectedOverline, (0.53 * 255, 0.53 * 255, 0.87 * 255, 0.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_DockingPreview         , (0.40 * 255, 0.40 * 255, 0.90 * 255, 0.32 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_DockingEmptyBg         , (0.20 * 255, 0.20 * 255, 0.20 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_PlotLines              , (1.00 * 255, 1.00 * 255, 1.00 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_PlotLinesHovered       , (0.90 * 255, 0.70 * 255, 0.00 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_PlotHistogram          , (0.90 * 255, 0.70 * 255, 0.00 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_PlotHistogramHovered   , (1.00 * 255, 0.60 * 255, 0.00 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TableHeaderBg          , (0.27 * 255, 0.27 * 255, 0.38 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TableBorderStrong      , (0.31 * 255, 0.31 * 255, 0.45 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TableBorderLight       , (0.26 * 255, 0.26 * 255, 0.28 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TableRowBg             , (0.00 * 255, 0.00 * 255, 0.00 * 255, 0.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TableRowBgAlt          , (1.00 * 255, 1.00 * 255, 1.00 * 255, 0.07 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TextLink               , (0.53 * 255, 0.53 * 255, 0.87 * 255, 0.80 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TextSelectedBg         , (0.00 * 255, 0.00 * 255, 1.00 * 255, 0.35 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TreeLines              , (0.50 * 255, 0.50 * 255, 0.50 * 255, 0.50 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_DragDropTarget         , (1.00 * 255, 1.00 * 255, 0.00 * 255, 0.90 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_DragDropTargetBg       , (0.00 * 255, 0.00 * 255, 0.00 * 255, 0.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_UnsavedMarker          , (0.90 * 255, 0.90 * 255, 0.90 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_NavCursor              , (0.45 * 255, 0.45 * 255, 0.90 * 255, 0.80 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_NavWindowingHighlight  , (1.00 * 255, 1.00 * 255, 1.00 * 255, 0.70 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_NavWindowingDimBg      , (0.80 * 255, 0.80 * 255, 0.80 * 255, 0.20 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ModalWindowDimBg       , (0.20 * 255, 0.20 * 255, 0.20 * 255, 0.35 * 255))
            dpg.add_theme_color(dpg.mvPlotCol_ErrorBar                , (0.90 * 255, 0.90 * 255, 0.90 * 255, 1.00 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_FrameBg                 , (0.43 * 255, 0.43 * 255, 0.43 * 255, 0.39 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_PlotBg                  , (0.00 * 255, 0.00 * 255, 0.00 * 255, 0.35 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_PlotBorder              , (0.50 * 255, 0.50 * 255, 0.50 * 255, 0.50 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_LegendBg                , (0.11 * 255, 0.11 * 255, 0.14 * 255, 0.92 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_LegendBorder            , (0.50 * 255, 0.50 * 255, 0.50 * 255, 0.50 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_LegendText              , (0.90 * 255, 0.90 * 255, 0.90 * 255, 1.00 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_TitleText               , (0.90 * 255, 0.90 * 255, 0.90 * 255, 1.00 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_InlayText               , (0.90 * 255, 0.90 * 255, 0.90 * 255, 1.00 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_AxisText                , (0.90 * 255, 0.90 * 255, 0.90 * 255, 1.00 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_AxisGrid                , (0.90 * 255, 0.90 * 255, 0.90 * 255, 0.25 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_Selection               , (0.97 * 255, 0.97 * 255, 0.39 * 255, 1.00 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_Crosshairs              , (0.50 * 255, 0.50 * 255, 0.50 * 255, 0.75 * 255), category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvNodeCol_NodeBackground          , (50, 50, 50, 255), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_NodeBackgroundHovered   , (75, 75, 75, 255), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_NodeBackgroundSelected  , (75, 75, 75, 255), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_NodeOutline             , (100, 100, 100, 255), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_TitleBar                , (69, 69, 138, 255), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_TitleBarHovered         , (82, 82, 161, 255), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_TitleBarSelected        , (82, 82, 161, 255), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_Link                    , (255, 255, 255, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_LinkHovered             , (105, 99, 204, 153), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_LinkSelected            , (105, 99, 204, 153), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_Pin                     , (89, 102, 156, 170), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_PinHovered              , (102, 122, 179, 200), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_BoxSelector             , (82, 82, 161, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_BoxSelectorOutline      , (82, 82, 161, 255), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_GridBackground          , (40, 40, 50, 200), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_GridLine                , (200, 200, 200, 40), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_GridLinePrimary         , (240, 240, 240, 60), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapBackground       , (25, 25, 25, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapBackgroundHovered, (25, 25, 25, 200), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapOutline          , (150, 150, 150, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapOutlineHovered   , (150, 150, 150, 200), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapNodeBackground   , (200, 200, 200, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapNodeBackgroundSelected, (200, 200, 240, 255), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapNodeOutline      , (200, 200, 200, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapLink             , (255, 255, 255, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapLinkSelected     , (105, 99, 204, 153), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapCanvas           , (200, 200, 200, 25), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapCanvasOutline    , (200, 200, 200, 200), category=dpg.mvThemeCat_Nodes)
...
def create_theme_imgui_light() -> Union[str, int]:
    ...
    with dpg.theme() as theme_id:
        with dpg.theme_component(0):
            ...
            dpg.add_theme_color(dpg.mvThemeCol_ResizeGripHovered      , (0.26 * 255, 0.59 * 255, 0.98 * 255, 0.67 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_ResizeGripActive       , (0.26 * 255, 0.59 * 255, 0.98 * 255, 0.95 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_InputTextCursor        , (0.00 * 255, 0.00 * 255, 0.00 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabHovered             , (0.26 * 255, 0.59 * 255, 0.98 * 255, 0.80 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_Tab                    , (0.76 * 255, 0.80 * 255, 0.84 * 255, 0.93 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabSelected            , (0.60 * 255, 0.73 * 255, 0.88 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabSelectedOverline    , (0.26 * 255, 0.59 * 255, 0.98 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabDimmed              , (0.92 * 255, 0.93 * 255, 0.94 * 255, 0.99 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabDimmedSelected      , (0.74 * 255, 0.82 * 255, 0.91 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TabDimmedSelectedOverline, (0.26 * 255, 0.59 * 255, 1.00 * 255, 0.00 * 255))
            ...
            dpg.add_theme_color(dpg.mvThemeCol_TextLink               , (0.26 * 255, 0.59 * 255, 0.98 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TextSelectedBg         , (0.26 * 255, 0.59 * 255, 0.98 * 255, 0.35 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_TreeLines              , (0.00 * 255, 0.00 * 255, 0.00 * 255, 0.30 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_DragDropTarget         , (0.26 * 255, 0.59 * 255, 0.98 * 255, 0.95 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_DragDropTargetBg       , (0.00 * 255, 0.00 * 255, 0.00 * 255, 0.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_UnsavedMarker          , (0.00 * 255, 0.00 * 255, 0.00 * 255, 1.00 * 255))
            dpg.add_theme_color(dpg.mvThemeCol_NavCursor              , (0.26 * 255, 0.59 * 255, 0.98 * 255, 0.80 * 255))
            ...
            dpg.add_theme_color(dpg.mvPlotCol_AxisTick                , (0.00 * 255, 0.00 * 255, 0.00 * 255, 0.25 * 255), category=dpg.mvThemeCat_Plots)
            ...
            dpg.add_theme_color(dpg.mvNodeCol_GridLinePrimary         , (120, 120, 120, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapBackground       , (25, 25, 25, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapBackgroundHovered, (25, 25, 25, 200), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapOutline          , (150, 150, 150, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapOutlineHovered   , (150, 150, 150, 200), category=dpg.mvThemeCat_Nodes)
            ...
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapNodeBackgroundSelected, (200, 200, 240, 255), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapNodeOutline      , (200, 200, 200, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapLink             , (66, 150, 250, 100), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapLinkSelected     , (66, 150, 250, 242), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapCanvas           , (200, 200, 200, 25), category=dpg.mvThemeCat_Nodes)
            dpg.add_theme_color(dpg.mvNodeCol_MiniMapCanvasOutline    , (200, 200, 200, 200), category=dpg.mvThemeCat_Nodes)
