...
namespace Marvel {
	...
	std::vector<std::pair<std::string, long>> GetModuleConstants()
	{
		std::vector<std::pair<std::string, long>> ModuleConstants =
		{
			...
			//-----------------------------------------------------------------------------
			// NEW Theme Color IDs
			// first 3 leading numbers are DPG item number and last 2 numbers are library specific 
			// color constants
			//-----------------------------------------------------------------------------
			{ "mvThemeCol_Window"                       , 002 },
			{ "mvThemeCol_Window_Border"                , 005 },
			{ "mvThemeCol_Window_Title"                 , 010 },
			{ "mvThemeCol_Window_TitleActive"           , 011 },
			{ "mvThemeCol_Window_TitleCollapsed"        , 012 },
			{ "mvThemeCol_Window_Scrollbar"             , 014 },
			{ "mvThemeCol_Window_ScrollbarGrab"         , 015 },
			{ "mvThemeCol_Window_ScrollbarGrabHovered"  , 016 },
			{ "mvThemeCol_Window_ScrollbarGrabActive"   , 017 },
			{ "mvThemeCol_Window_ResizeGrip"            , 030 },
			{ "mvThemeCol_Window_ResizeGripHovered"     , 031 },
			{ "mvThemeCol_Window_ResizeGripActive"      , 032 },
			{ "mvThemeCol_Button"                       , 121 },
			{ "mvThemeCol_Button_Text"                  , 100 },
			{ "mvThemeCol_Button_Hovered"               , 122 },
			{ "mvThemeCol_Button_Active"                , 123 },
			{ "mvThemeCol_Spacing"                      , 227 },
			{ "mvThemeCol_Spacing_Hovered"              , 228 },
			{ "mvThemeCol_Spacing_Active"               , 229 },
