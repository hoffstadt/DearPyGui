...
#define mvImGuiCol_TextDisabled MV_BASE_COL_textDisabledColor
...
#define mvImGuiCol_Link mvColor(255, 255, 255, 200)
#define mvImGuiCol_LinkHovered mvColor(66, 150, 250, 255)
#define mvImGuiCol_LinkSelected mvColor(66, 150, 250, 255)
#define mvImGuiCol_Pin mvColor(199, 199, 41, 255)
#define mvImGuiCol_PinHovered mvColor(255, 255, 50, 255)
#define mvImGuiCol_BoxSelector mvColor(61, 133, 224, 30)
#define mvImGuiCol_BoxSelectorOutline mvColor(61, 133, 224, 150)
#define mvImGuiCol_GridBackground mvColor(35, 35, 35, 255)
#define mvImGuiCol_GridLine mvColor(0, 0, 0, 255)
