...
namespace Marvel {
	...
	private:
		...
		template<>
		std::shared_ptr<int> add_internal_value(const std::string& name, int value)
		{
			if (HasValue(name))
			{
		...
		template<>
		std::shared_ptr<std::array<int, 2>> add_internal_value(const std::string& name, std::array<int, 2> value)
		{
		...
		template<>
		std::shared_ptr<std::array<int, 3>> add_internal_value(const std::string& name, std::array<int, 3> value)
		{
			if (HasValue(name))
			{
		...
		template<>
		std::shared_ptr<std::array<int, 4>> add_internal_value(const std::string& name, std::array<int, 4> value)
		{
			if (HasValue(name))
			{
		...
		template<>
		std::shared_ptr<float> add_internal_value(const std::string& name, float value)
		{
			if (HasValue(name))
			{
		...
		template<>
		std::shared_ptr<std::array<float, 2>> add_internal_value(const std::string& name, std::array<float, 2> value)
		{
			if (HasValue(name))
			{
		...
		template<>
		std::shared_ptr<std::array<float, 3>> add_internal_value(const std::string& name, std::array<float, 3> value)
		{
			if (HasValue(name))
			{
		...
		template<>
		std::shared_ptr<std::array<float, 4>> add_internal_value(const std::string& name, std::array<float, 4> value)
		{
			if (HasValue(name))
			{
		...
		template<>
		std::shared_ptr<std::vector<float>> add_internal_value(const std::string& name, std::vector<float> value)
		{
			if (HasValue(name))
			{
		...
		template<>
		std::shared_ptr<bool> add_internal_value(const std::string& name, bool value)
		{
			if (HasValue(name))
			{
		...
		template<>
		std::shared_ptr<std::string> add_internal_value(const std::string& name, std::string value)
		{
			if (HasValue(name))
			{
		...
		template<>
		std::shared_ptr<tm> add_internal_value(const std::string& name, tm value)
		{
			if (HasValue(name))
			{
		...
		template<>
		std::shared_ptr<ImPlotTime> add_internal_value(const std::string& name, ImPlotTime value)
		{
			if (HasValue(name))
			{
				if (GetType(name) != StorageValueTypes::Time)
		...
		//-----------------------------------------------------------------------------
		template<>
		std::shared_ptr<int> get_internal_value(const std::string& name)
		{
		...
		template<>
		std::shared_ptr<std::array<int,2>> get_internal_value(const std::string& name)
		{
			if (HasValueExternal(name))
			{
		...
		template<>
		std::shared_ptr<std::array<int, 3>> get_internal_value(const std::string& name)
		{
			if (HasValueExternal(name))
			{
		...
		template<>
		std::shared_ptr<std::array<int, 4>> get_internal_value(const std::string& name)
		{
			if (HasValueExternal(name))
			{
		...
		template<>
		std::shared_ptr<float> get_internal_value(const std::string& name)
		{
			if (HasValueExternal(name))
			{
		...
		template<>
		std::shared_ptr<std::array<float, 2>> get_internal_value(const std::string& name)
		{
			if (HasValueExternal(name))
			{
		...
		template<>
		std::shared_ptr<std::array<float, 3>> get_internal_value(const std::string& name)
		{
			if (HasValueExternal(name))
			{
		...
		template<>
		std::shared_ptr<std::array<float, 4>> get_internal_value(const std::string& name)
		{
			if (HasValueExternal(name))
			{
		...
		template<>
		std::shared_ptr<std::vector<float>> get_internal_value(const std::string& name)
		{
			if (HasValueExternal(name))
			{
		...
		template<>
		std::shared_ptr<bool> get_internal_value(const std::string& name)
		{
			if (HasValueExternal(name))
			{
		...
		template<>
		std::shared_ptr<std::string> get_internal_value(const std::string& name)
		{
			if (HasValueExternal(name))
			{
		...
		template<>
		std::shared_ptr<tm> get_internal_value(const std::string& name)
		{
			if (HasValueExternal(name))
			{
		...
		template<>
		std::shared_ptr<ImPlotTime> get_internal_value(const std::string& name)
		{
			if (HasValueExternal(name))
			{
				auto item = (mvTimePtrBase*)s_externalReferences[name];
