...
namespace Marvel {
	...
	PyObject* mvInput::get_mouse_pos(PyObject* self, PyObject* args, PyObject* kwargs)
	{
		int local = true;
	...
	PyObject* mvInput::get_mouse_drag_delta(PyObject* self, PyObject* arg, PyObject* kwargss)
	{
	...
	PyObject* mvInput::is_key_pressed(PyObject* self, PyObject* args, PyObject* kwargs)
	{
		int key;
	...
	PyObject* mvInput::is_key_released(PyObject* self, PyObject* args, PyObject* kwargs)
	{
		int key;
	...
	PyObject* mvInput::is_key_down(PyObject* self, PyObject* args, PyObject* kwargs)
	{
		int key;
	...
	PyObject* mvInput::is_mouse_button_dragging(PyObject* self, PyObject* args, PyObject* kwargs)
	{
		int button;
		float threshold;
	...
	PyObject* mvInput::is_mouse_button_down(PyObject* self, PyObject* args, PyObject* kwargs)
	{
		int button;
	...
	PyObject* mvInput::is_mouse_button_clicked(PyObject* self, PyObject* args, PyObject* kwargs)
	{
		int button;
	...
	PyObject* mvInput::is_mouse_button_double_clicked(PyObject* self, PyObject* args, PyObject* kwargs)
	{
		int button;
