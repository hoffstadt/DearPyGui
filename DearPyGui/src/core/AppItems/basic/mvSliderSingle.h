...
namespace Marvel {
    ...
    public:
        ...
        MV_START_COLOR_CONSTANTS
            ...
            MV_ADD_CONSTANT(mvThemeCol_SliderFloat_Bg,             mvColor_Primary(80), mvColor(128, 128, 128, 63)),
    ...
    public:
        ...
        MV_START_COLOR_CONSTANTS
            ...
            MV_ADD_CONSTANT(mvThemeCol_SliderInt_Bg,               mvColor_Primary(80), mvColor(128, 128, 128, 63)),
