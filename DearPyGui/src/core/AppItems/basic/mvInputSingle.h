...
namespace Marvel {
    ...
    public:
        ...
        MV_START_COLOR_CONSTANTS
            ...
            MV_ADD_CONSTANT(mvThemeCol_InputInt_ButtonBg, mvImGuiCol_Button, mvColor(128, 128, 128, 63)),
    ...
    public:
        ...
        MV_START_COLOR_CONSTANTS
            ...
            MV_ADD_CONSTANT(mvThemeCol_InputFloat_ButtonBg, mvImGuiCol_Button, mvColor(128, 128, 128, 63)),
