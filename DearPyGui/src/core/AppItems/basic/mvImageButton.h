...
namespace Marvel {
	...
	class mvImageButton : public mvAppItem, public mvEventHandler
	{
		...
		MV_START_COLOR_CONSTANTS
			MV_CREATE_CONSTANT_PAIR(mvThemeCol_ImageButton_Bg,           mvColor(255, 255, 255, 255)),
			MV_CREATE_CONSTANT_PAIR(mvThemeCol_ImageButton_BgHovered,    mvColor(255, 255, 255, 255)),
			MV_CREATE_CONSTANT_PAIR(mvThemeCol_ImageButton_BgActive,     mvColor(255, 255, 255, 255)),
			MV_CREATE_CONSTANT_PAIR(mvThemeCol_ImageButton_Border,       mvColor(255, 255, 255, 255)),
			MV_CREATE_CONSTANT_PAIR(mvThemeCol_ImageButton_BorderShadow, mvColor(255, 255, 255, 255)),
