...
namespace Marvel {
	...
	void mvDataGrid::InsertParser(std::map<std::string, mvPythonParser>* parsers)
	{
...

		{
			...
			parser.addArg<mvPyDataType::String>("data_grid", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::ListStrList>("data", mvArgType::REQUIRED);
			parser.finalize();
...

		{
			mvPythonParser parser(mvPyDataType::None);
			parser.addArg<mvPyDataType::String>("data_grid", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::StringList>("headers", mvArgType::REQUIRED);
			parser.finalize();
...

		{
			mvPythonParser parser(mvPyDataType::None);
			parser.addArg<mvPyDataType::String>("data_grid", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::String>("name", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::StringList>("column", mvArgType::REQUIRED);
			parser.finalize();
...

		{
			mvPythonParser parser(mvPyDataType::None);
			parser.addArg<mvPyDataType::String>("data_grid", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::Integer>("column_index", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::String>("name", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::StringList>("column", mvArgType::REQUIRED);
			parser.finalize();
...

		{
			mvPythonParser parser(mvPyDataType::None);
			parser.addArg<mvPyDataType::String>("data_grid", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::StringList>("row", mvArgType::REQUIRED);
			parser.finalize();
...

		{
			mvPythonParser parser(mvPyDataType::None);
			parser.addArg<mvPyDataType::String>("data_grid", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::Integer>("row_index", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::StringList>("row", mvArgType::REQUIRED);
			parser.finalize();
...

		{
			mvPythonParser parser(mvPyDataType::None);
			parser.addArg<mvPyDataType::String>("data_grid", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::Integer>("row", mvArgType::REQUIRED);
			parser.finalize();
...

		{
			...
			parser.addArg<mvPyDataType::String>("data_grid", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::Integer>("row", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::Integer>("column", mvArgType::REQUIRED);
			parser.finalize();
			parsers->insert({ "delete_grid_row", parser });
		}

		{
			...
			parser.addArg<mvPyDataType::Integer>("row", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::Integer>("column", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::String>("value", mvArgType::REQUIRED);
			parser.finalize();
...

		{
			...
			parser.addArg<mvPyDataType::Integer>("row", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::Integer>("column", mvArgType::REQUIRED);
			parser.addArg<mvPyDataType::Bool>("value", mvArgType::REQUIRED);
			parser.finalize();
