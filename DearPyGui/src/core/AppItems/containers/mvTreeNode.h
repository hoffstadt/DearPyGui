...
namespace Marvel {
	...
	class mvTreeNode : public mvBoolPtrBase
	{
		...
		MV_START_COLOR_CONSTANTS
			...
			MV_CREATE_CONSTANT_PAIR(mvThemeCol_TreeNode_BgHovered, mvColor(255, 255, 255, 255)),
			MV_CREATE_CONSTANT_PAIR(mvThemeCol_TreeNode_BgActive, mvColor(255, 255, 255, 255)),
