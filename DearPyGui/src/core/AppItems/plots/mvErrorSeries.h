...
namespace Marvel {
	...
	MV_REGISTER_WIDGET(mvErrorSeries, MV_ITEM_DESC_DEFAULT, StorageValueTypes::Series, 1);
	...
	public:
		...
		MV_APPLY_WIDGET_REGISTRATION2(mvAppItemType::mvErrorSeries, add_error_series)
