...
namespace Marvel {
	...
	MV_REGISTER_WIDGET(mvCandleSeries, MV_ITEM_DESC_DEFAULT, StorageValueTypes::VectFloatVect, 1);
	class mvCandleSeries : public mvSeriesBase
	{
		...
		public:
			...
			MV_APPITEM_TYPE(mvAppItemType::mvCandleSeries, add_candle_series)
