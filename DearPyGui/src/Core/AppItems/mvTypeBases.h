...
namespace Marvel {
	...
	protected:
		...
		int* m_value = nullptr;
		int m_disabled_value[4] {0, 0, 0, 0};
	};
	...
	protected:
		...
		float* m_value = nullptr;
		float m_disabled_value[2]{ 0.0, 0.0 };
	};
	...
	protected:
		...
		float* m_value = nullptr;
		float m_disabled_value[3]{ 0.0 ,0.0, 0.0 };
	};
	...
	protected:
		...
		float* m_value = nullptr;
		float m_disabled_value[4]{ 0.0, 0.0, 0.0, 0.0 };
	};
