...
def add_window(name: str, width: int = ..., height: int = ..., start_x: int = ..., start_y: int = ..., autosize: bool = ..., resizable: bool = ..., title_bar: bool = ..., movable: bool = ..., hide: bool = ..., on_close: str = ...) -> None:
