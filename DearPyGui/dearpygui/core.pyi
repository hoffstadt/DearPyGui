...
def add_area_series(x : List[float], y : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, fill: List[int] =(0, 0, 0, -255), axis: int =0, contribute_to_bounds: bool =True) -> str:
	"""Undocumented function"""
	...

def add_bar_series(x : List[float], y : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, weight: float =1.0, axis: int =0, horizontal: bool =False, contribute_to_bounds: bool =True) -> str:
	"""Undocumented function"""
	...

def add_button(*, id: str =..., width: int =0, height: int =0, indent: int =-1, parent: str ='', before: str ='', label: str ='', callback: Callable =None, callback_data: Any =None, show: bool =True, enabled: bool =True, small: bool =False, arrow: bool =False, direction: int =0) -> str:
	"""Undocumented function"""
	...

def add_candle_series(dates : List[float], opens : List[float], closes : List[float], lows : List[float], highs : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, bull_color: List[int] =(0, 255, 113, 255), bear_color: List[int] =(218, 13, 79, 255), axis: int =0, weight: int =0.25, contribute_to_bounds: bool =True, tooltip: bool =True) -> str:
	"""Undocumented function"""
	...

def add_checkbox(*, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', callback: Callable =None, callback_data: Any =None, show: bool =True, enabled: bool =True, default_value: bool =False) -> str:
	"""Undocumented function"""
	...

def add_child(*, id: str =..., width: int =0, height: int =0, indent: int =-1, parent: str ='', before: str ='', show: bool =True, border: bool =True, autosize_x: bool =False, autosize_y: bool =False, no_scrollbar: bool =False, horizontal_scrollbar: bool =False, menubar: bool =False) -> str:
	"""Undocumented function"""
	...

def add_collapsing_header(*, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', show: bool =True, closable: bool =False, default_open: bool =False, open_on_double_click: bool =False, open_on_arrow: bool =False, leaf: bool =False, bullet: bool =False) -> str:
	"""Undocumented function"""
	...

def add_color_button(default_value : List[int] =(0, 0, 0, 255), *, id: str =..., width: int =0, height: int =0, indent: int =-1, parent: str ='', before: str ='', callback: Callable =None, callback_data: Any =None, show: bool =True, enabled: bool =True, no_alpha: bool =False, no_border: bool =False, no_drag_drop: bool =False) -> str:
	"""Undocumented function"""
	...
...
def add_colormap_scale(*, id: str =..., width: int =0, height: int =0, indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, default_value: int =0, min_scale: float =0.0, max_scale: float =1.0) -> str:
	"""Undocumented function"""
	...
...
def add_drag_line(*, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', callback: Callable =None, show: bool =True, default_value: Any =(0.0, 0.0, 0.0, 0.0), color: List[int] =(0, 0, 0, -255), thickness: float =1.0, show_label: bool =True, vertical: bool =True) -> str:
	"""Undocumented function"""
	...

def add_drag_point(*, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', callback: Callable =None, show: bool =True, default_value: Any =(0.0, 0.0, 0.0, 0.0), color: List[int] =(0, 0, 0, -255), thickness: float =1.0, show_label: bool =True) -> str:
	"""Undocumented function"""
	...
...
def add_dummy(*, id: str =..., width: int =0, height: int =0, indent: int =-1, parent: str ='', before: str ='', show: bool =True) -> str:
	"""Undocumented function"""
	...

def add_dynamic_texture(width : int, height : int, default_value : List[float], *, id: str =..., indent: int =-1, parent: str ='') -> str:
	"""Undocumented function"""
	...

def add_error_series(x : List[float], y : List[float], negative : List[float], positive : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, axis: int =0, contribute_to_bounds: bool =True, horizontal: bool =False) -> str:
	"""Undocumented function"""
	...
...
def add_group(*, id: str =..., width: int =0, indent: int =-1, parent: str ='', before: str ='', show: bool =True, horizontal: bool =False, horizontal_spacing: float =-1) -> str:
	"""Undocumented function"""
	...

def add_heat_series(x : List[float], rows : int, cols : int, *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, scale_min: float =0.0, scale_max: float =1.0, bounds_min: Any =(0.0, 0.0), bounds_max: Any =(1.0, 1.0), format: str ='%0.1f', contribute_to_bounds: bool =True) -> str:
	"""Undocumented function"""
	...

def add_hline_series(x : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, axis: int =0, contribute_to_bounds: bool =True) -> str:
	"""Undocumented function"""
	...

def add_image(default_value : str, *, id: str =..., width: int =0, height: int =0, indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, tint_color: List[float] =(255, 255, 255, 255), border_color: List[float] =(0, 0, 0, 0), uv_min: List[float] =(0.0, 0.0), uv_max: List[float] =(1.0, 1.0)) -> str:
	"""Undocumented function"""
	...
...
def add_image_series(value : str, bounds_min : List[float], bounds_max : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, uv_min: List[float] =(0.0, 0.0), uv_max: List[float] =(1.0, 1.0), tint_color: List[int] =(255, 255, 255, 255), axis: int =0, contribute_to_bounds: bool =True) -> str:
	"""Undocumented function"""
	...
...
def add_knob_float(*, id: str =..., width: int =0, height: int =0, indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', callback: Callable =None, callback_data: Any =None, show: bool =True, default_value: float =0.0, min_value: float =0.0, max_value: float =100.0) -> str:
	"""Undocumented function"""
	...

def add_line_series(x : List[float], y : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, axis: int =0, contribute_to_bounds: bool =True) -> str:
	"""Undocumented function"""
	...
...
def add_loading_indicator(*, id: str =..., width: int =0, height: int =0, indent: int =-1, parent: str ='', before: str ='', label: str ='', show: bool =True, style: int =0) -> str:
	"""Undocumented function"""
	...
...
def add_node_link(node_1 : str, node_2 : str, *, id: str =..., indent: int =-1, parent: str ='', show: bool =True) -> str:
	"""Undocumented function"""
	...

def add_pie_series(x : float, y : float, radius : float, values : List[float], labels : List[str], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, format: str ='%0.2f', angle: float =90.0, axis: int =0, normalize: bool =False, contribute_to_bounds: bool =True) -> str:
	"""Undocumented function"""
	...
...
def add_plot_annotation(*, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, default_value: Any =(0.0, 0.0), offset: List[float] =(0.0, 0.0), color: List[int] =(0, 0, 0, -255), clamped: bool =True) -> str:
	"""Undocumented function"""
	...
...
def add_progress_bar(*, id: str =..., width: int =0, height: int =0, indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, overlay: str ='', default_value: float =0.0) -> str:
	"""Undocumented function"""
	...
...
def add_same_line(*, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True, xoffset: float =0.0, spacing: float =-1.0) -> str:
	"""Undocumented function"""
	...

def add_scatter_series(x : List[float], y : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, axis: int =0, contribute_to_bounds: bool =True) -> str:
	"""Undocumented function"""
	...

def add_selectable(*, id: str =..., width: int =0, height: int =0, indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', callback: Callable =None, callback_data: Any =None, show: bool =True, enabled: bool =True, default_value: bool =False, span_columns: bool =False) -> str:
	"""Undocumented function"""
	...

def add_separator(*, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True) -> str:
	"""Undocumented function"""
	...

def add_shade_series(x : List[float], y1 : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, y2: Any =[], axis: int =0, contribute_to_bounds: bool =True) -> str:
	"""Undocumented function"""
	...
...
def add_spacing(*, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True, count: int =1) -> str:
	"""Undocumented function"""
	...

def add_staging_container(*, id: str =..., indent: int =-1) -> str:
	"""Undocumented function"""
	...

def add_stair_series(x : List[float], y : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, axis: int =0, contribute_to_bounds: bool =True) -> str:
	"""Undocumented function"""
	...

def add_static_texture(width : int, height : int, default_value : List[float], *, id: str =..., indent: int =-1, parent: str ='', file: str ='') -> str:
	"""Undocumented function"""
	...
...
def add_tab_bar(*, id: str =..., indent: int =-1, parent: str ='', before: str ='', callback: Callable =None, callback_data: Any =None, show: bool =True, reorderable: bool =False) -> str:
	"""Undocumented function"""
	...
...
def add_text_point(x : float, y : float, *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, x_offset: int =..., y_offset: int =..., axis: int =0, contribute_to_bounds: bool =True, vertical: bool =False) -> str:
	"""Undocumented function"""
	...

def add_texture_container(*, id: str =..., indent: int =-1, show: bool =True) -> str:
	"""Undocumented function"""
	...

def add_time_picker(*, id: str =..., indent: int =-1, parent: str ='', before: str ='', callback: Callable =None, callback_data: Any =None, show: bool =True, default_value: dict ={'hour': 14, 'min': 32, 'sec': 23}, hour24: bool =False) -> str:
	"""Undocumented function"""
	...
...
def add_vline_series(x : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', label: str ='', source: str ='', show: bool =True, axis: int =0, contribute_to_bounds: bool =True) -> str:
	"""Undocumented function"""
	...
...
def draw_arrow(p1 : List[float], p2 : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True, color: List[int] =(255, 255, 255, 255), thickness: float =1.0, size: int =4) -> str:
	"""Undocumented function"""
	...

def draw_bezier_curve(p1 : List[float], p2 : List[float], p3 : List[float], p4 : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True, color: List[int] =(255, 255, 255, 255), thickness: float =1.0, size: int =4, segments: int =0) -> str:
	"""Undocumented function"""
	...

def draw_circle(center : List[float], radius : float, *, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True, color: List[int] =(255, 255, 255, 255), fill: List[int] =(0, 0, 0, -255), thickness: float =1.0, size: int =4, segments: int =0) -> str:
	"""Undocumented function"""
	...

def draw_image(file : str, pmin : List[float], pmax : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True, uv_min: List[float] =(0.0, 0.0), uv_max: List[float] =(1.0, 1.0), color: List[int] =(255, 255, 255, 255)) -> str:
	"""Undocumented function"""
	...

def draw_line(p1 : List[float], p2 : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True, color: List[int] =(255, 255, 255, 255), thickness: float =1.0) -> str:
	"""Undocumented function"""
	...

def draw_polygon(points : List[List[float]], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True, color: List[int] =(255, 255, 255, 255), fill: List[int] =(0, 0, 0, -255), thickness: float =1.0) -> str:
	"""Undocumented function"""
	...

def draw_polyline(points : List[List[float]], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True, closed: bool =False, color: List[int] =(255, 255, 255, 255), thickness: float =1.0) -> str:
	"""Undocumented function"""
	...

def draw_quad(p1 : List[float], p2 : List[float], p3 : List[float], p4 : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True, color: List[int] =(255, 255, 255, 255), fill: List[int] =(0, 0, 0, -255), thickness: float =1.0) -> str:
	"""Undocumented function"""
	...

def draw_rectangle(pmin : List[float], pmax : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True, color: List[int] =(255, 255, 255, 255), fill: List[int] =(0, 0, 0, -255), rounding: float =0.0, thickness: float =1.0) -> str:
	"""Undocumented function"""
	...

def draw_text(pos : List[float], text : str, *, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True, color: List[int] =(255, 255, 255, 255), size: int =10) -> str:
	"""Undocumented function"""
	...

def draw_triangle(p1 : List[float], p2 : List[float], p3 : List[float], *, id: str =..., indent: int =-1, parent: str ='', before: str ='', show: bool =True, color: List[int] =(255, 255, 255, 255), fill: List[int] =(0, 0, 0, -255), thickness: float =1.0) -> str:
	"""Undocumented function"""
	...
