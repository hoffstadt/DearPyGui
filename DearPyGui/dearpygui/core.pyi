...
def add_link(editor: str, obj_id: int, start_attribute: int, end_attribute: int, *, def add_listbox(name: str, *, items: List[str] = (), default_value: int = 0, callback: Callable = None, callback_data: Any = None, tip: str = '', parent: str = '', before: str = '', source: str = '', enabled: bool = True, width: int = 0, num_items: int = 3, label: str = '', popup: str = '', show: bool = True) -> None:
	"""Adds a listbox."""
	...
