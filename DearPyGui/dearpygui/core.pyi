...
def add_area_series(x : List[float], y : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, show: bool =True, fill: List[int] =(0, 0, 0, -255), contribute_to_bounds: bool =True) -> int:
	"""Undocumented function"""
	...

def add_bar_series(x : List[float], y : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, show: bool =True, weight: float =1.0, horizontal: bool =False, contribute_to_bounds: bool =True) -> int:
	"""Undocumented function"""
	...

def add_button(*, label: str =None, id: int =..., width: int =0, height: int =0, indent: int =-1, parent: int =0, before: int =0, payload_type: str ='$$DPG_PAYLOAD', callback: Callable =None, drag_callback: Callable =None, drop_callback: Callable =None, user_data: Any =None, show: bool =True, enabled: bool =True, pos: List[int] =[], filter_key: str ='', tracked: bool =False, track_offset: float =0.5, small: bool =False, arrow: bool =False, direction: int =0) -> int:
	"""Undocumented function"""
	...

def add_candle_series(dates : List[float], opens : List[float], closes : List[float], lows : List[float], highs : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, show: bool =True, bull_color: List[int] =(0, 255, 113, 255), bear_color: List[int] =(218, 13, 79, 255), weight: int =0.25, contribute_to_bounds: bool =True, tooltip: bool =True) -> int:
	"""Undocumented function"""
	...
...
def add_child(*, label: str =None, id: int =..., width: int =0, height: int =0, indent: int =-1, parent: int =0, before: int =0, payload_type: str ='$$DPG_PAYLOAD', drag_callback: Callable =None, drop_callback: Callable =None, show: bool =True, pos: List[int] =[], filter_key: str ='', delay_search: str =False, tracked: bool =False, track_offset: float =0.5, border: bool =True, autosize_x: bool =False, autosize_y: bool =False, no_scrollbar: bool =False, horizontal_scrollbar: bool =False, menubar: bool =False) -> int:
	"""Undocumented function"""
	...
...
def add_clipper(*, label: str =None, id: int =..., width: int =0, indent: int =-1, parent: int =0, before: int =0, show: bool =True, delay_search: str =False) -> int:
	"""Undocumented function"""
	...

def add_collapsing_header(*, label: str =None, id: int =..., indent: int =-1, parent: int =0, before: int =0, payload_type: str ='$$DPG_PAYLOAD', drag_callback: Callable =None, drop_callback: Callable =None, show: bool =True, pos: List[int] =[], filter_key: str ='', delay_search: str =False, tracked: bool =False, track_offset: float =0.5, closable: bool =False, default_open: bool =False, open_on_double_click: bool =False, open_on_arrow: bool =False, leaf: bool =False, bullet: bool =False) -> int:
	"""Undocumented function"""
	...
...
def add_drag_line(*, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, callback: Callable =None, show: bool =True, default_value: Any =(0.0, 0.0, 0.0, 0.0), color: List[int] =(0, 0, 0, -255), thickness: float =1.0, show_label: bool =True, vertical: bool =True) -> int:
	"""Undocumented function"""
	...

def add_drag_payload(*, label: str =None, id: int =..., parent: int =0, show: bool =True, drag_data: Any =None, payload_type: str ='$$DPG_PAYLOAD') -> int:
	"""Undocumented function"""
	...

def add_drag_point(*, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, callback: Callable =None, show: bool =True, default_value: Any =(0.0, 0.0, 0.0, 0.0), color: List[int] =(0, 0, 0, -255), thickness: float =1.0, show_label: bool =True) -> int:
	"""Undocumented function"""
	...

def add_draw_layer(*, label: str =None, id: int =..., parent: int =0, before: int =0, show: bool =True) -> int:
	"""Undocumented function"""
	...

def add_drawlist(*, label: str =None, id: int =..., width: int =0, height: int =0, parent: int =0, before: int =0, payload_type: str ='$$DPG_PAYLOAD', callback: Callable =None, drag_callback: Callable =None, drop_callback: Callable =None, user_data: Any =None, show: bool =True, pos: List[int] =[], filter_key: str ='', delay_search: str =False, tracked: bool =False, track_offset: float =0.5) -> int:
	"""Undocumented function"""
	...

def add_dummy(*, label: str =None, id: int =..., width: int =0, height: int =0, indent: int =-1, parent: int =0, before: int =0, show: bool =True, pos: List[int] =[]) -> int:
	"""Undocumented function"""
	...

def add_dynamic_texture(width : int, height : int, default_value : List[float], *, label: str =None, id: int =..., parent: int =0) -> int:
	"""Undocumented function"""
	...
...
def add_error_series(x : List[float], y : List[float], negative : List[float], positive : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, show: bool =True, contribute_to_bounds: bool =True, horizontal: bool =False) -> int:
	"""Undocumented function"""
	...
...
def add_group(*, label: str =None, id: int =..., width: int =0, indent: int =-1, parent: int =0, before: int =0, payload_type: str ='$$DPG_PAYLOAD', drag_callback: Callable =None, drop_callback: Callable =None, show: bool =True, pos: List[int] =[], filter_key: str ='', delay_search: str =False, tracked: bool =False, track_offset: float =0.5, horizontal: bool =False, horizontal_spacing: float =-1) -> int:
	"""Undocumented function"""
	...

def add_handler_registry(*, label: str =None, id: int =..., show: bool =True) -> int:
	"""Undocumented function"""
	...

def add_heat_series(x : List[float], rows : int, cols : int, *, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, show: bool =True, scale_min: float =0.0, scale_max: float =1.0, bounds_min: Any =(0.0, 0.0), bounds_max: Any =(1.0, 1.0), format: str ='%0.1f', contribute_to_bounds: bool =True) -> int:
	"""Undocumented function"""
	...

def add_histogram_series(x : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, show: bool =True, bins: int =-1, bar_scale: float =1.0, min_range: float =0.0, max_range: float =1.0, cumlative: bool =False, density: bool =False, outliers: bool =True, contribute_to_bounds: bool =True) -> int:
	"""Undocumented function"""
	...

def add_hline_series(x : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, show: bool =True, contribute_to_bounds: bool =True) -> int:
	"""Undocumented function"""
	...
...
def add_key_down_handler(key : int =-1, *, label: str =None, id: int =..., parent: int =0, callback: Callable =None, user_data: Any =None, show: bool =True) -> int:
	"""Undocumented function"""
	...

def add_key_press_handler(key : int =-1, *, label: str =None, id: int =..., parent: int =0, callback: Callable =None, user_data: Any =None, show: bool =True) -> int:
	"""Undocumented function"""
	...

def add_key_release_handler(key : int =-1, *, label: str =None, id: int =..., parent: int =0, callback: Callable =None, user_data: Any =None, show: bool =True) -> int:
	"""Undocumented function"""
	...
...
def add_menu_bar(*, label: str =None, id: int =..., indent: int =-1, parent: int =0, show: bool =True, delay_search: str =False) -> int:
	"""Undocumented function"""
	...

def add_menu_item(*, label: str =None, id: int =..., indent: int =-1, parent: int =0, before: int =0, payload_type: str ='$$DPG_PAYLOAD', callback: Callable =None, drag_callback: Callable =None, drop_callback: Callable =None, user_data: Any =None, show: bool =True, enabled: bool =True, filter_key: str ='', tracked: bool =False, track_offset: float =0.5, default_value: bool =False, shortcut: str ='', check: bool =False) -> int:
	"""Undocumented function"""
	...

def add_mouse_click_handler(button : int =-1, *, label: str =None, id: int =..., parent: int =0, callback: Callable =None, user_data: Any =None, show: bool =True) -> int:
	"""Undocumented function"""
	...

def add_mouse_double_click_handler(button : int =-1, *, label: str =None, id: int =..., parent: int =0, callback: Callable =None, user_data: Any =None, show: bool =True) -> int:
	"""Undocumented function"""
	...

def add_mouse_down_handler(button : int =-1, *, label: str =None, id: int =..., parent: int =0, callback: Callable =None, user_data: Any =None, show: bool =True) -> int:
	"""Undocumented function"""
	...

def add_mouse_drag_handler(button : int =-1, threshold : float =10.0, *, label: str =None, id: int =..., parent: int =0, callback: Callable =None, user_data: Any =None, show: bool =True) -> int:
	"""Undocumented function"""
	...

def add_mouse_move_handler(*, label: str =None, id: int =..., parent: int =0, callback: Callable =None, user_data: Any =None, show: bool =True) -> int:
	"""Undocumented function"""
	...

def add_mouse_release_handler(button : int =-1, *, label: str =None, id: int =..., parent: int =0, callback: Callable =None, user_data: Any =None, show: bool =True) -> int:
	"""Undocumented function"""
	...

def add_mouse_wheel_handler(*, label: str =None, id: int =..., parent: int =0, callback: Callable =None, user_data: Any =None, show: bool =True) -> int:
	"""Undocumented function"""
	...

def add_node(*, label: str =None, id: int =..., parent: int =0, before: int =0, payload_type: str ='$$DPG_PAYLOAD', drag_callback: Callable =None, drop_callback: Callable =None, show: bool =True, pos: List[int] =[], filter_key: str ='', delay_search: str =False, tracked: bool =False, track_offset: float =0.5, draggable: bool =True) -> int:
	"""Undocumented function"""
	...

def add_node_attribute(*, label: str =None, id: int =..., indent: int =-1, parent: int =0, before: int =0, payload_type: str ='$$DPG_PAYLOAD', drag_callback: Callable =None, drop_callback: Callable =None, show: bool =True, filter_key: str ='', tracked: bool =False, track_offset: float =0.5, output: bool =False, static: bool =False, shape: int =54010) -> int:
	"""Undocumented function"""
	...

def add_node_editor(*, label: str =None, id: int =..., parent: int =0, before: int =0, payload_type: str ='$$DPG_PAYLOAD', callback: Callable =None, drag_callback: Callable =None, drop_callback: Callable =None, show: bool =True, filter_key: str ='', delay_search: str =False, tracked: bool =False, track_offset: float =0.5, delink_callback: Callable =None) -> int:
	"""Undocumented function"""
	...

def add_node_link(node_1 : int, node_2 : int, *, label: str =None, id: int =..., parent: int =0, show: bool =True) -> int:
	"""Undocumented function"""
	...

def add_pie_series(x : float, y : float, radius : float, values : List[float], labels : List[str], *, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, show: bool =True, format: str ='%0.2f', angle: float =90.0, normalize: bool =False, contribute_to_bounds: bool =True) -> int:
	"""Undocumented function"""
	...

def add_plot(*, label: str =None, id: int =..., width: int =0, height: int =0, indent: int =-1, parent: int =0, before: int =0, payload_type: str ='$$DPG_PAYLOAD', callback: Callable =None, drag_callback: Callable =None, drop_callback: Callable =None, user_data: Any =None, show: bool =True, pos: List[int] =[], filter_key: str ='', delay_search: str =False, tracked: bool =False, track_offset: float =0.5, no_title: bool =False, no_menus: bool =False, no_box_select: bool =False, no_mouse_pos: bool =False, no_highlight: bool =False, no_child: bool =False, query: bool =False, crosshairs: bool =False, anti_aliased: bool =False, equal_aspects: bool =False) -> int:
	"""Undocumented function"""
	...

def add_plot_annotation(*, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, show: bool =True, default_value: Any =(0.0, 0.0), offset: List[float] =(0.0, 0.0), color: List[int] =(0, 0, 0, -255), clamped: bool =True) -> int:
	"""Undocumented function"""
	...

def add_plot_axis(axis : int, *, label: str =None, id: int =..., parent: int =0, payload_type: str ='$$DPG_PAYLOAD', drag_callback: Callable =None, drop_callback: Callable =None, show: bool =True, no_gridlines: bool =False, no_tick_marks: bool =False, no_tick_labels: bool =False, log_scale: bool =False, invert: bool =False, lock_min: bool =False, lock_max: bool =False, time: bool =False) -> int:
	"""Undocumented function"""
	...
...
def add_same_line(*, label: str =None, id: int =..., parent: int =0, before: int =0, show: bool =True, xoffset: float =0.0, spacing: float =-1.0) -> int:
	"""Undocumented function"""
	...

def add_scatter_series(x : List[float], y : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, show: bool =True, contribute_to_bounds: bool =True) -> int:
	"""Undocumented function"""
	...
...
def add_separator(*, label: str =None, id: int =..., indent: int =-1, parent: int =0, before: int =0, show: bool =True, pos: List[int] =[]) -> int:
	"""Undocumented function"""
	...

def add_shade_series(x : List[float], y1 : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, show: bool =True, y2: Any =[], contribute_to_bounds: bool =True) -> int:
	"""Undocumented function"""
	...

def add_simple_plot(*, label: str =None, id: int =..., width: int =0, height: int =0, indent: int =-1, parent: int =0, before: int =0, source: int =0, payload_type: str ='$$DPG_PAYLOAD', drag_callback: Callable =None, drop_callback: Callable =None, show: bool =True, filter_key: str ='', tracked: bool =False, track_offset: float =0.5, default_value: List[float] =(), overlay: str ='', histogram: bool =False, autosize: bool =True, min_scale: float =0.0, max_scale: float =0.0) -> int:
	"""Undocumented function"""
	...
...
def add_spacing(*, label: str =None, id: int =..., indent: int =-1, parent: int =0, before: int =0, show: bool =True, pos: List[int] =[], count: int =1) -> int:
	"""Undocumented function"""
	...

def add_staging_container(*, label: str =None, id: int =...) -> int:
	"""Undocumented function"""
	...

def add_stair_series(x : List[float], y : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, show: bool =True, contribute_to_bounds: bool =True) -> int:
	"""Undocumented function"""
	...

def add_static_texture(width : int, height : int, default_value : List[float], *, label: str =None, id: int =..., parent: int =0, file: str ='') -> int:
	"""Undocumented function"""
	...

def add_stem_series(x : List[float], y : List[float], *, label: str =None, id: int =..., indent: int =-1, parent: int =0, before: int =0, source: int =0, show: bool =True, contribute_to_bounds: bool =True) -> int:
	"""Undocumented function"""
	...
...
def add_text(default_value : str ='', *, label: str =None, id: int =..., indent: int =-1, parent: int =0, before: int =0, source: int =0, show: bool =True, pos: List[int] =[], filter_key: str ='', tracked: bool =False, track_offset: float =0.5, wrap: int =-1, bullet: bool =False, color: List[float] =(-1, -1, -1, -1), show_label: bool =False) -> int:
	"""Undocumented function"""
	...

def add_text_point(x : float, y : float, *, label: str =None, id: int =..., parent: int =0, before: int =0, source: int =0, show: bool =True, x_offset: int =..., y_offset: int =..., contribute_to_bounds: bool =True, vertical: bool =False) -> int:
	"""Undocumented function"""
	...
...
def add_theme(*, label: str =None, id: int =..., default_theme: bool =False) -> int:
	"""Undocumented function"""
	...

def add_theme_color(target : int =0, value : List[int] =(0, 0, 0, 255), *, label: str =None, id: int =..., parent: int =0, category: int =0) -> int:
	"""Undocumented function"""
	...

def add_theme_style(target : int =0, x : float =1.0, y : float =-1.0, *, label: str =None, id: int =..., parent: int =0, category: int =0) -> int:
	"""Undocumented function"""
	...
...
def add_tooltip(parent : str, *, label: str =None, id: int =..., show: bool =True) -> int:
	"""Undocumented function"""
	...
...
def add_viewport_drawlist(*, label: str =None, id: int =..., show: bool =True, filter_key: str ='', delay_search: str =False, front: bool =True) -> int:
	"""Undocumented function"""
	...
...
def draw_bezier_cubic(p1 : List[float], p2 : List[float], p3 : List[float], p4 : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, show: bool =True, color: List[int] =(255, 255, 255, 255), thickness: float =1.0, size: int =4, segments: int =0) -> int:
	"""Undocumented function"""
	...

def draw_bezier_quadratic(p1 : List[float], p2 : List[float], p3 : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, show: bool =True, color: List[int] =(255, 255, 255, 255), thickness: float =1.0, size: int =4, segments: int =0) -> int:
	"""Undocumented function"""
	...

def draw_circle(center : List[float], radius : float, *, label: str =None, id: int =..., parent: int =0, before: int =0, show: bool =True, color: List[int] =(255, 255, 255, 255), fill: List[int] =(0, 0, 0, -255), thickness: float =1.0, segments: int =0) -> int:
	"""Undocumented function"""
	...

def draw_ellipse(pmin : List[float], pmax : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, show: bool =True, color: List[int] =(255, 255, 255, 255), fill: List[int] =(0, 0, 0, -255), thickness: float =1.0, segments: int =32) -> int:
	"""Undocumented function"""
	...
...
def draw_line(p1 : List[float], p2 : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, show: bool =True, color: List[int] =(255, 255, 255, 255), thickness: float =1.0) -> int:
	"""Undocumented function"""
	...

def draw_polygon(points : List[List[float]], *, label: str =None, id: int =..., parent: int =0, before: int =0, show: bool =True, color: List[int] =(255, 255, 255, 255), fill: List[int] =(0, 0, 0, -255), thickness: float =1.0) -> int:
	"""Undocumented function"""
	...

def draw_polyline(points : List[List[float]], *, label: str =None, id: int =..., parent: int =0, before: int =0, show: bool =True, closed: bool =False, color: List[int] =(255, 255, 255, 255), thickness: float =1.0) -> int:
	"""Undocumented function"""
	...

def draw_quad(p1 : List[float], p2 : List[float], p3 : List[float], p4 : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, show: bool =True, color: List[int] =(255, 255, 255, 255), fill: List[int] =(0, 0, 0, -255), thickness: float =1.0) -> int:
	"""Undocumented function"""
	...

def draw_rectangle(pmin : List[float], pmax : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, show: bool =True, color: List[int] =(255, 255, 255, 255), fill: List[int] =(0, 0, 0, -255), rounding: float =0.0, thickness: float =1.0) -> int:
	"""Undocumented function"""
	...

def draw_text(pos : List[float], text : str, *, label: str =None, id: int =..., parent: int =0, before: int =0, show: bool =True, color: List[int] =(255, 255, 255, 255), size: int =10) -> int:
	"""Undocumented function"""
	...

def draw_triangle(p1 : List[float], p2 : List[float], p3 : List[float], *, label: str =None, id: int =..., parent: int =0, before: int =0, show: bool =True, color: List[int] =(255, 255, 255, 255), fill: List[int] =(0, 0, 0, -255), thickness: float =1.0) -> int:
	"""Undocumented function"""
	...
