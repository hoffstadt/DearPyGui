...
with window("Input Text##dialog", 500, 500, autosize=True, show=False):
    add_input_text("Regular##inputtext", data_source="string")
...
with window("Widgets##dialog", 500, 500, show=False):
    ...
    with tab_bar("Tab Bar##widget"):
        ...
        with tab("Basic Widgets##widget"):
            ...
            add_radio_button("Radio Button##widget", items=("Item 1", "Item 2", "item 3"), horizontal=True, data_source="int")
            add_listbox("Listbox##widget", items=("Item 1", "Item 2", "item 3"), data_source="int")
            add_progress_bar("Progress Bar##widget", 0.45, overlay="Progress Bar", height = 100, data_source="float")
            add_text("Text")
            add_selectable("Selectable##widget", data_source="bool")
            add_input_text("Input Text##widget", data_source="string")
            add_label_text("Label Text##123", "value", data_source="string")
            ...
            add_input_float4("Input Float4##widget", data_source="float4")
            add_input_int("Input Int##widget", data_source="int")
            add_input_int2("Input Int2##widget", data_source="int2")
            add_input_int3("Input Int3##widget", data_source = "int3")
            add_input_int4("Input Int4##widget", data_source = "int4")
            add_drag_float("Drag Float##widget", data_source="float")
            add_drag_float2("Drag Float2##widget", data_source="float2")
            add_drag_float3("Drag Float3##widget", data_source="float3")
            add_drag_float4("Drag Float4##widget", data_source="float4")
            add_drag_int("Drag Int##widget", data_source = "int")
            add_drag_int2("Drag Int2##widget", data_source = "int2")
            add_drag_int3("Drag Int3##widget", data_source = "int3")
            add_drag_int4("Drag Int4##widget", data_source = "int4")
            add_slider_float("Slider Float##widget", data_source="float")
            add_slider_float2("Slider Float2##widget", data_source="float2")
            add_slider_float3("Slider Float3##widget", data_source="float3")
            add_slider_float4("Slider Float4##widget", data_source="float4")
            add_slider_int("Slider Int##widget", data_source="int")
            add_slider_int2("Slider Int2##widget", data_source="int2")
            add_slider_int3("Slider Int3##widget", data_source = "int3")
            add_slider_int4("Slider Int4##widget", data_source = "int4")
